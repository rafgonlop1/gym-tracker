...
const pushTemplate: WorkoutExercise[] = [
  {
    exerciseId: uuidv4(),
...
const pullTemplate: WorkoutExercise[] = [
  {
    exerciseId: uuidv4(),
...
const legsTemplate: WorkoutExercise[] = [
  {
    exerciseId: uuidv4(),
...
const plyometricsTemplate: WorkoutExercise[] = [
  {
    exerciseId: uuidv4(),
...
export const workoutTemplates = {
  ...
  pull: pullTemplate,
  legs: legsTemplate,
  plyometrics: plyometricsTemplate,
};
